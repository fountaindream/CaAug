...
_C.DATA.ROOT = '/data0/lfy_data/CGN/datasets'
...
# Domain Augmentation loss
_C.LOSS.AUG = 'domainaug'
# -----------------------------------------------------------------------------
# Training settings
# -----------------------------------------------------------------------------
_C.TRAIN = CN()
...
def update_config(config, args):
    ...
    if args.aug_loss_weight:
        config.LOSS.AUG_LOSS_WEIGHT = args.aug_loss_weight
    if args.p:
        config.probability = args.p        
